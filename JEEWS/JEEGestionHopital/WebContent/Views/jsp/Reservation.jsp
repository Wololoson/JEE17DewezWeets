...
<html>
	<head>
		...
		<script>
			window.onload = function(){
				...
				var delClose = document.getElementsByClassName("close")[1];
				var resSuppr = document.getElementById("resSuppr");
				var radios = document.getElementsByClassName("res");
	...
	<div id="modalSuppr" class="modal">
		<div class="modal-content">
			...
			<form action="ServletReservation" method="post">
				<table cellspacing="0" cellpadding="5">
					...
					<tr>
						<td colspan="2">
							<input type="hidden" name="resSuppr" id="resSuppr"/>
		...
		<form action="ServletReservation" method="post">
			<table id="resTab" border="1" cellspacing="0" cellpadding="5">
				<tr>
					...
					for(Reservation r : lr.getListReservation()){
						...
						<tr>
							...
							sess.setAttribute(Integer.toString(i), r);%>
								...
								<td>
									<input type="radio" id="res" name="res" value="<%=i %>" class="res"/>
								</td>
							<%}
